...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_1Valet.Device.Domain.Entities.Device", b =>
                {
            ...
            modelBuilder.Entity("_1Valet.Device.Domain.Entities.DeviceType", b =>
                {
                    b.Property<int>("DeviceTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_1Valet.Device.Domain.Entities.DeviceUser", b =>
                {
            ...
            modelBuilder.Entity("_1Valet.Device.Domain.Entities.DeviceUserDevice", b =>
                {
                    b.Property<int>("DeviceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_1Valet.Device.Domain.Entities.Device", b =>
                {
                    b.HasOne("_1Valet.Device.Domain.Entities.DeviceType", "DeviceType")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("_1Valet.Device.Domain.Entities.DeviceUserDevice", b =>
                {
                    b.HasOne("_1Valet.Device.Domain.Entities.Device", "Device")
                        .WithMany("DeviceUserDevices")
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_1Valet.Device.Domain.Entities.DeviceUser", "DeviceUser")
                        .WithMany("DeviceUserDevices")
